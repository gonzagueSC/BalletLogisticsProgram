...
public class FilePaths {
	...
	public static final File storageFolder = new File(configFolder, "Data");
	...
	public static final File AdminRoles = new File(AdminFolder, "adminRoles");
	...
	public static final File ClassSchedules = new File(AdminFolder, "active_schedules");
	public static final File AuditSchedules = new File(AdminFolder, "audit_schedules");
	public static final File Costumes = new File(AdminFolder, "costumes");
