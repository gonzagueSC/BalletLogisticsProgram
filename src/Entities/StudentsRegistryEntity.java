...
public class StudentsRegistryEntity extends RegistryEntity {
	...
	public StudentEntity getStudent ( String firstName, String lastName, String dateOfBirth ) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
	...
	@SuppressWarnings("unused")
	public synchronized void addStudent ( Map<EntityField, String> entityValues ) throws IllegalClassFormatException,
		...
		if ( studentAlreadyExists(firstName, lastName, dateOfBirth) ) throw new AppWarning("Student Already Exists");
		
		
		String nextID = EntityMapper.getInstance().getEntity(ConfigEntity.class).returnNextStudentID();
		String studentDisplay = firstName + " " + lastName + dateOfBirth;
	...
	public String getStudentID ( String firstName, String lastName, String dateOfBirth ) {
		...
		if ( !studentsMap().containsKey(lookup) ) throw new IllegalArgumentException("Student not found");
