...
public class ShowPerformancesLeft extends Panel {
	...
	public ShowPerformancesLeft(ShowPerformances Panel) {
	...
	public void Update(String name) {
		...
		showName = name;
		newPerformance = new Button("+ Performance", (e -> DialogGenerator.newPerformanceDialog(name, this)), BOTTOMADDDim, BOTTOMADDLEFTX,
				BOTTOMADDY, TextColor, BOTTOMADDARCRAD, BOTTOMADDFONTSIZE);

		String[] allRoles = ProductionsModule.getAllPerformancesByProduction(name);
		...
		for (int i = 0; i < allRoles.length; i++) {
			...
			Button Production = new Button(RoleName.split(", ")[0], (e -> parent.Update(RoleName)),
